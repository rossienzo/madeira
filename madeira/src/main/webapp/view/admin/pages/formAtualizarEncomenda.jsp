          ...
          <div class="col-lg-12">
            ...
            <form role="form" method="post" action="/madeira/ServletItemEncomenda">
              <div class="box-body">
                  ...
                  <input type="text" class="form-control idinput" value="${ iEncomenda.getId() }" id="itemEncomendaId" name="itemEncomendaId">
                  <input type="text" class="form-control idinput" value="${ iEncomenda.getEncomenda().getId() }" id="encomendaId" name="encomendaId">
                </div>
              	<div class="form-group">
                  <label for="movelName">Data</label>
                  <input type="datetime-local" class="form-control" id="data" name="data" value="${ iEncomenda.getEncomenda().getData() }">
                </div>
                <div class="form-group">
                  <label for="movelModelo">Data prevista</label>
                  <input type="datetime-local" class="form-control" id="dataPrevista" name="dataPrevista" value="${ iEncomenda.getEncomenda().dataPrevista }">
                </div>
                <div class="form-group">
                  <label for="movelDescricao">Data de entrega</label>
                  <input type="datetime-local" class="form-control" id="dataEntrega" name="dataEntrega" value="${ iEncomenda.getEncomenda().dataEntrega }">
                </div>
                <div class="form-group">
                  <label for="movelPreco">Data de vencimento</label>
                  <input type="datetime-local" step=any class="form-control" id="dataVencimento" name="dataVencimento" value="${ iEncomenda.getEncomenda().dataVencimento }">
                </div>
                <div class="form-group">
                  <label for="movelPreco">Data de pagamento</label>
                  <input type="datetime-local" step=any class="form-control" id="dataPagamento" name="dataPagamento" value="${ iEncomenda.getEncomenda().dataPagamento }">
                </div>
                <div class="form-group">
                  <label for="movelPreco">Data de prontidão</label>
                  <input type="datetime-local" step=any class="form-control" id="dataProntidao" name="dataProntidao" value="${ iEncomenda.getEncomenda().dataProntidao }">
                </div>
                <div class="form-group">
                  ...
                  <select id="cliente" class="form-control" name="cliente">
                    <c:forEach var="cliente" items="${clientes}">
						<c:choose>
						    <c:when test="${ iEncomenda.getEncomenda().getCliente().getId() == cliente.getId() }">
