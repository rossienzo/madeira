  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Criar Móvel</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="col-lg-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Novo Móvel</h3>
            </div>
            ...
            <form role="form" method="post" action="/madeira/ServletMovel?acao=inserir">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="movelName" name="movelName" placeholder="Digite o nome do móvel">
                </div>
                <div class="form-group">
                  <label for="movelModelo">Modelo</label>
                  <input type="text" class="form-control" id="movelModelo" name="movelModelo" placeholder="Digite o modelo do móvel">
                </div>
                <div class="form-group">
                  <label for="movelDescricao">Descrição</label>
                  <input type="text" class="form-control" id="movelDescricao" name="movelDescricao" placeholder="Digite a descrição do móvel">
                </div>
                <div class="form-group">
                  <label for="movelPreco">Preço</label>
                  <input type="number" step=any class="form-control" id="movelPreco" name="movelPreco" placeholder="Digite o preço do móvel">
                </div>
                <div class="form-group">
